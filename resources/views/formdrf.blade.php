...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div>
    ...
    <div>
      <label class="desc" id="title1" for="Field1" name="to">Service Dapaterment Head</label>
    </div>
  </div>
  ...
  <div>
    <fieldset>
      ...
      <div>
        ...
        <div>
          <input id="Field2_0" name="cc" type="radio" value="First Choice" tabindex="5" checked="checked">
  ...
  <div>
    ...
    <div>
      <input id="Field4" name="ci_adress" type="text" class="field text fn" value="" size="8" tabindex="1" placeholder="Adress">
    </div>
  </div>
  ...
  <div>
    ...
    <div>
      <input id="Field5" name="di_date" type="text" class="field text fn" value="" size="8" tabindex="1" placeholder="Date">
    </div>
    <div>
  ...
  <div>
    <fieldset>
      ...
      <div>
        ...
        <div>
          <input id="Field6_0" name="number_of_engineering" type="radio" value="First Choice" tabindex="5" checked="checked">
          <label class="choice" for="Field6_0">1</label>
        </div>
        <div>
          <input id="Field6_1" name="number_of_engineering" type="radio" value="Second Choice" tabindex="6">
          <label class="choice" for="Field6_1">2</label>
        </div>
        <div>
          <input id="Field6_2" name="number_of_engineering" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field6_2">3</label>
        </div>
        <div>
          <input id="Field6_3" name="number_of_engineering" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field6_3">4</label>
        </div>
        <div>
          <input id="Field6_4" name="number_of_engineering" type="radio" value="Third Choice" tabindex="7">
  ...
  <div>
    <fieldset>
      ...
      <div>
        ...
        <div>
          <input id="Field8_0" name="lodging_recomendation" type="radio" value="First Choice" tabindex="5" checked="checked">
          <label class="choice" for="Field8_0">Provided by Customer</label>
        </div>
        <div>
          <input id="Field8_1" name="lodging_recomendation" type="radio" value="Second Choice" tabindex="6">
          <label class="choice" for="Field8_1">Provided by YIN</label>
        </div>
        <div>
          <input id="Field8_2" name="lodging_recomendation" type="radio" value="Third Choice" tabindex="7">
  ...
  <div>
    ...
    <div>
      <input id="Field9" name="scope_instrument_code" type="text" class="field text fn" value="" size="8" tabindex="1" placeholder="Model Code">
    </div>
  </div>
    ...
    <fieldset>
     ...
     Post Work Document :
      ...
      <div>
        ...
        <div>
          <input id="Field10_0" name="post_work_document" type="radio" value="First Choice" tabindex="5" checked="checked">
          <label class="choice" for="Field10_0">Service / Investigation Report</label>
        </div>
        <div>
          <input id="Field10_1" name="post_work_document" type="radio" value="Second Choice" tabindex="6">
          <label class="choice" for="Field10_1">Time</label>
        </div>
        <div>
          <input id="Field10_5" name="post_work_document" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field10_3">FAT/SAT REPORT</label>
        </div>
        <div>
          <input id="Field10_4" name="post_work_document" type="radio" value="Third Choice" tabindex="7">
        ...
        <div>
          <input id="Field10_8" name="post_work_document" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field10_6">Delivery </label>
        </div>
        <div>
          <input id="Field10_7" name="post_work_document" type="radio" value="Third Choice" tabindex="7">
  ...
  <div>
    <fieldset>
      ...
      <div>
        ...
        <div>
          <input id="Field11_0" name="work_type" type="radio" value="First Choice" tabindex="5" checked="checked">
          <label class="choice" for="Field11_0">Calibration</label>
        </div>
        <div>
          <input id="Field11_1" name="work_type" type="radio" value="Second Choice" tabindex="6">
          <label class="choice" for="Field11_1">Bench Repair</label>
        </div>
        <div>
          <input id="Field11_2" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_2">Call Out</label>
        </div>
        <div>
          <input id="Field11_3" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_3">VPS Work  </label>
        </div>
        <div>
          <input id="Field11_4" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_4">Setup/Commisioning </label>
        </div>
        <div>
          <input id="Field11_5" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_5">Not Delivery </label>
        </div>
        <div>
          <input id="Field11_6" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_6">Conducting Training </label>
        </div>
        <div>
          <input id="Field11_7" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_7">S/W & H/W Modification </label>
        </div>
        <div>
          <input id="Field11_8" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_8">TroubleShooting </label>
        </div>
        <div>
          <input id="Field11_9" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_9">Sales Support  </label>
        </div>
        <div>
          <input id="Field11_10" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_10">Project Support </label>
        </div>
        <div>
          <input id="Field11_11" name="work_type" type="radio" value="Third Choice" tabindex="7">
          <label class="choice" for="Field11_11">Site  </label>
        </div>
        <div>
          <input id="Field11_12" name="work_type" type="radio" value="Third Choice" tabindex="7">
  ...
  <div>
    <fieldset>
      ...
      <div>
        ...
        <div>
          <input id="Field14_0" name="current_work_status" type="radio" value="First Choice" tabindex="5" checked="checked">
          <label class="choice" for="Field14_0">Completed</label>
        </div>
        <div>
          <input id="Field14_1" name="current_work_status" type="radio" value="Second Choice" tabindex="6">
          <label class="choice" for="FField14_1">Pending</label>
        </div>
        <div>
          <input id="Field14_2" name="current_work_status" type="radio" value="Third Choice" tabindex="7">
